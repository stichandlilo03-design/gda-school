...
export default async function TeacherSchoolInfoPage() {
  ...
  const school = teacher?.schools?.[0]?.school;
  if (!school) return <div className="p-8 text-center text-gray-400">No school found</div>;
