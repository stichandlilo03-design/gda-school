...
const sections = [
  ...
  },
  {
    ...
    steps: [
      "Go to 'Classroom' and select the class you want to teach from the dropdown.",
      "Click 'Start Session' to begin a live class. Students will be notified and can join.",
      "Use the interactive blackboard to write lessons — students see your writing in real-time.",
      "Toggle between 'Board Mode' (writing) and 'Voice Mode' (speaking/explaining).",
      "When students raise their hand (✋), you'll see a notification. Click to respond with a Q&A.",
      "Use the Chat panel to communicate with all students during the session.",
      "Create Polls to quiz students — set a question, options, and correct answer. Students vote and you see results.",
      "Use 'Whisper' to send private messages to individual students without others seeing.",
      "The session timer shows elapsed time. Sessions auto-end based on school settings (typically 40 min).",
      "Click 'End Session' when done — your teaching credit is automatically calculated and added to payroll.",
    ],
    tips: ["Sessions auto-start based on timetable — but you can also start manually.", "You earn credits for every minute taught (minimum 1 minute for network issues).", "Students who arrive late are tracked — you can see late minutes in your session history."],
  },
  {
